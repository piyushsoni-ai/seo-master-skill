...
1. Install the `seo-master` folder.
...
# Install SEO Master in Different AI Agents

## Codex

1. Keep the folder name as `seo-master`.
...
5. Tell Codex: "Use the SEO Master skill. Read SKILL.md first."

## Claude Projects

1. Upload the full `seo-master` folder or ZIP.
2. Add this project instruction:
   "Use SEO Master as the operating system for SEO, AEO/GEO, backlinks, local SEO, competitor research, keyword mapping, and reporting. Read SKILL.md first."

## OpenClaw

1. Add the folder to your skills or agent knowledge directory.
2. Register/alias it as `seo-master`.
