...
SEO Master should prefer Apify Intelligence Mode whenever Apify is available.
...
SEO Master works in five modes. The agent must choose the correct mode before starting an audit, strategy, competitor analysis, backlink plan, or AEO/GEO task.
