...
SEO Master 1.0.2 uses Apify as the primary data layer. The skill should ask for only `APIFY_API_TOKEN` by default, then use Apify actors for crawling, SERP, competitors, Maps/local, reviews, Trends, PageSpeed/Lighthouse, GSC/GA4-style connector or export workflows, and backlink/authority checks where available.
...
**SEO Master** is a portable AI-agent skill for serious SEO, AEO/GEO, local SEO, competitor research, backlink evaluation, and client-ready SEO growth planning.
...
SEO Master is a senior SEO strategist inside an agent.
...
If data is missing, SEO Master must say the data is missing.
...
SEO Master is Apify-first because Apify can act as a flexible SEO data layer for crawling, SERP scraping, maps/local checks, trends, authority-style scrapers, and competitor research.

If Apify is not available, SEO Master falls back to native browsing/scraping/search tools, uploaded files, or advisory workflows.

---

## Standard Output Philosophy

Every useful SEO Master output must tell the user:
...
SEO Master now includes a dedicated AI-friendly SEO workflow.
